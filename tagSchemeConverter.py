...
##
# Function added by Karmen
def BIO2BILOU(input_file, output_file):
    print("Convert BIO -> BILOU for file:", input_file)
    with open(input_file, 'r', encoding='utf-8') as in_file:
        fins = in_file.readlines()
    fout = open(output_file, 'w', encoding='utf-8')
    words = []
    ...
    for line in fins:
        if len(line) < 3:
            ...
            labels.append(pair[-1].upper())
    fout.close()
    print("BILOU file generated:", output_file)
##
...
if __name__ == '__main__':
    ...
    ##
    # Added by Karmen
    elif sys.argv[1].upper() == "BIO2BILOU":
        BIO2BILOU(sys.argv[2],sys.argv[3])
    ##
